...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Measurement.ingredient'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Ingredient'], null=True, blank=True))
        db.alter_column('core_measurement', 'ingredient_id', orm['core.measurement:ingredient'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Measurement.ingredient'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Ingredient']))
        db.alter_column('core_measurement', 'ingredient_id', orm['core.measurement:ingredient'])
